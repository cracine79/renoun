...
tonebender.photo.attach(io: URI.open(), filename: 'boss_od1.webp'
...
colorsound.photo.attach(io: URI.open(), filename: 'tyrannochorus'
...
colorsound.photo.attach(io: URI.open(), filename: 'colorsound'
...
cooperFx.photo.attach(io: URI.open(), filename: 'colorsound'
...
bossHm2.photo.attach(io: URI.open(), filename: 'colorsound'
...
bossDm2.photo.attach(io: URI.open(), filename: 'colorsound'
...
walrus.photo.attach(io: URI.open(), filename: 'colorsound'
...
pinkPanther.photo.attach(io: URI.open(), filename: 'colorsound'
...
octaveClang.photo.attach(io: URI.open(), filename: 'colorsound'
...
dynamicWah.photo.attach(io: URI.open(), filename: 'colorsound'
...
dodEnvelope.photo.attach(io: URI.open(), filename: 'colorsound'
...
danArmstrong.photo.attach(io: URI.open(), filename: 'colorsound'
...
demonKing.photo.attach(io: URI.open(), filename: 'colorsound'
...
fiveState.photo.attach(io: URI.open(), filename: 'colorsound'
...
catlinBread.photo.attach(io: URI.open(), filename: 'colorsound'
...
bigMuff.photo.attach(io: URI.open(), filename: 'colorsound'
...
tweakFuzz.photo.attach(io: URI.open(), filename: 'colorsound'
...
akaiProductionCenter.photo.attach(io: URI.open(), filename: 'colorsound'


yamahaMotif.photo.attach(io: URI.open(), filename: 'colorsound'
...
rolandSaturn.photo.attach(io: URI.open(), filename: 'colorsound'
...
korg.photo.attach(io: URI.open(), filename: 'colorsound'
...
makeNoise.photo.attach(io: URI.open(), filename: 'colorsound'
...
casio.photo.attach(io: URI.open(), filename: 'colorsound'
...
canativesio.photo.attach(io: URI.open(), filename: 'colorsound'
...
novation.photo.attach(io: URI.open(), filename: 'colorsound'
...
alesis.photo.attach(io: URI.open(), filename: 'colorsound'
...
polyend.photo.attach(io: URI.open(), filename: 'colorsound'
...
casioRap.photo.attach(io: URI.open(), filename: 'colorsound'
