        ...
        if (shortGuitars[0]){
            return(
             ...
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart1' onClick={(e)=> addFavorite(shortGuitars[0].id, 1, e)} ></div>  
                    <div src="/assets/images/filledHeart.png"   className = 'likeOff' id='luHeart1'onClick={(e)=> unFavorite(shortGuitars[0].id, 1, e)} > </div>
                </div>
        ...
        if (shortGuitars[1]){
            return(
                <>
                     <div className='thumb-instrumentWrapper'>
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart2' onClick={(e)=> addFavorite(shortGuitars[1].id, 2, e)}></div>  
                    <div src="/assets/images/filledHeart.png"   className = 'likeOff' id='luHeart2'onClick={(e)=> unFavorite(shortGuitars[1].id, 2, e)}></div> 
                </div>
        ...
        if (shortGuitars[2]){
            return(
                <>
                    <div className='thumb-instrumentWrapper'>
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart3' onClick={(e)=> addFavorite(shortGuitars[2].id, 3, e)}> </div>
                    <div src="/assets/images/filledHeart.png"  className = 'likeOff' id='luHeart3'onClick={(e)=> unFavorite(shortGuitars[2].id, 3, e)}></div> 
                </div>
        ...
        if (shortGuitars[3]){
            return(
                <>
                     <div className='thumb-instrumentWrapper'>
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart4' onClick={(e)=> addFavorite(shortGuitars[3].id, 4, e)}></div>  
                    <div src="/assets/images/filledHeart.png"   className = 'likeOff' id='luHeart4'onClick={(e)=> unFavorite(shortGuitars[3].id, 4, e)}> </div>
            </div>
        ...
        if (shortGuitars[4]){
            return(
                <>
                     <div className='thumb-instrumentWrapper'>
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart5' onClick={(e)=> addFavorite(shortGuitars[4].id, 5, e)}></div>  
                    <div src="/assets/images/filledHeart.png"   className = 'likeOff' id='luHeart5'onClick={(e)=> unFavorite(shortGuitars[4].id, 5, e)}></div>
            </div>
        ...
        if (shortGuitars[5]){
            return(
                <>
                     <div className='thumb-instrumentWrapper'>
             <div className='carousel-fav-button'>
                    <div src='/assets/images/emptyHeart.png' className = 'likeOn' id='ioMdHeart6' onClick={(e)=> addFavorite(shortGuitars[5].id, 6, e)}></div>  
                    <div src="/assets/images/filledHeart.png"   className = 'likeOff' id='luHeart6'onClick={(e)=> unFavorite(shortGuitars[5].id, 6, e)}></div> 
            </div>
